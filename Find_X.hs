...
-- * Implementations of searchable functions
...
-- | Calculates the minimal number of positions required, to yield the desired position. Starting from the requested position it calculates prior positions if needed and constructs the tail of the solution recursively when necessary.
